...
static inline int is_char_printable(char c)
{
    return (c >= 31 && c < 127);
}

static inline int is_char_lowercase(char c)
{
    return (c >= 'a' && c <= 'z');
}

static inline int is_char_uppercase(char c)
{
    return (c >= 'A' && c <= 'Z');
}

static inline int is_char_alpha(char c)
{
